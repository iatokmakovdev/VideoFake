...
def get_face_enhancer() -> Any:
    ...
    with THREAD_LOCK:
        if FACE_ENHANCER is None:
            model_path = resolve_relative_path('/content/VideoFake/roop/models/GFPGANv1.3.pth')
...
def pre_check() -> bool:
    download_directory_path = resolve_relative_path('/content/VideoFake/roop/models')
